...
float *get_ref(float *arr, int i) { return &arr[i]; }
...
void test_common_cross_correlation_nopadding(void) {
  ...
  float m1_values[] = {4.f, 3.f, 8.f, 9.f, 1.f, 2.f, 7.f, 7.f, 6.f};
  matrix2d_load(&m1, 3, 3, &m1_values[0]);

  float m2_values[] = {4, 3, 3, 2};
  ...
  int result_height;
  int result_width;
  compute_output_size(m1.height, m1.width, m2.height, padding, stride,
...
void test_common_max_pooling(void) {
  ...
  float m_values[] = {4.f, 3.f, 8.f, 9.f, 1.f, 2.f, 7.f, 7.f, 6.f};
  ...
  int result_height;
  int result_width;
  compute_output_size(m.height, m.width, kernel_size, padding, stride,
                      &result_height, &result_width);
  matrix2d_init(&result, result_height, result_width);
